...
public class UpdatePasswordPresenter extends RxPresenter<UpdatePasswordConstract.View> implements UpdatePasswordConstract.Presenter {
    ...
    @Inject
    public UpdatePasswordPresenter(SmsModel smsModel, UserModel userModel) {
    ...
    public void getSMSCode(String mobile) {
        Disposable disposable = smsModel.getSMSCodePassword(mobile)
    ...
    public void updatePassword(String password, String smsCode) {
        Disposable disposable = userModel.updatePassword(password, smsCode)
                .subscribeWith(new ResultDisposable<String>() {
